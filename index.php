                ...
                <form class="navbar-form navbar-left" role="search">
                    <div class="input-group">
                        ...
                        <div class="input-group-btn">
                            <button type="button" class="btn btn-success" id="btnSearch"><i
                            ...
                            <div class="col-md-12 border-right">
                                <div class="col-md-3">
                                    <a href="chitiet.php?id_tin=<?= $sanpham->id ?>">
                                        <img class="img-responsive" src="assets/image/sanpham/<?= $sanpham->image ?>"
                                            alt="">
                                    </a>
                                </div>
                                <div class="col-md-9">
                                    ...
                                    <p><?= $sanpham->tomtat ?></p>
                                    <a class="btn btn-primary" href="chitiet.php?id_tin=<?= $sanpham->id ?>">Chi tiết
        ...
        <div class="row footer-music" style="background-color: DarkCyan ;">
            <div class="col-sm-12">
                <div class="col-md-3 text-center text-md-left">
                    <img style="width: 35%; height: auto; margin-bottom: 2rem; margin-top: 2rem" class="img-fluid mb-4"
                        src="assets/image/shoplogo.png">
